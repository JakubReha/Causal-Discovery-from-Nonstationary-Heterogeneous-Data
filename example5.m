...
T_1 = 200;
x1_1 = randn(T_1,1);
x2_1 = 0.9*x1_1 + 0.1*randn(T_1,1);
x3_1 = linspace(0.9, 0, T_1)'.*x2_1 + 0.1*randn(T_1,1); 
x4_1 = 0.9*x3_1 + 0.1*randn(T_1,1); 
Data_1 = [x1_1,x2_1,x3_1,x4_1];

% generate data from the second domain
T_2 = 400;
x1_2 = randn(T_2,1);
x2_2 = 0.9*x1_2 + 0.1*randn(T_2,1);
x3_2 = [linspace(0, 0.9, T_2/2), 0.9*ones(1, T_2/2)]'.*x2_2 + 0.1*randn(T_2,1); 
x4_2 = 0.9*x3_2 + 0.1*randn(T_2,1); 
...
pars.widthT = 0.9; % the kernel width on the time index; set it to zero for domain-varying data
...
plots.driving_force(3, :) = 10*[linspace(0.9, 0, T_1),linspace(0, 0.9, T_2/2), 0.9*ones(1, T_2/2)];
